...
import com.github.sugarmgp.eoc.entity.*;
import com.github.sugarmgp.eoc.entity.render.*;
import com.github.sugarmgp.eoc.utils.EntityRenderFactory;
...
public class EntityHandler {
    public static void register() {
        ...
        EntityRegistry.registerModEntity(new ResourceLocation(EOC.MODID, "entity.sugarmgp"), EntitySugarMGP.class,
                "eoc.entity_sugarmgp", 1, EOC.instance, 64, 1, true, 0xB3FFFF, 0x4D94FF);
    ...
    public static void registerRenders() {
        ...
        registerEntityRender(EntitySugarMGP.class, RenderSugarMGP.class);
    ...
    public static void registerSpawn() {
        ...
        registerEntitySpawn(EntitySugarMGP.class, 4, 1, 2, EnumCreatureType.CREATURE, biomes);
        registerEntitySpawn(EntityZijing.class, 4, 1, 2, EnumCreatureType.CREATURE, biomes);
