...
public class EntitySugarMGP extends EntityNPCBase {
    private static DataParameter<Byte> SPRINKLED = EntityDataManager.createKey(EntitySugarMGP.class, DataSerializers.BYTE);

    public EntitySugarMGP(World worldIn) {
